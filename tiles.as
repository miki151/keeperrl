...
void genTiles() {
  ...
  addTile(GHOST, sprite(6, 16).setTranslucent(0.5));
  addTile(SPIRIT, sprite(17, 14));
  addTile(DEVIL, sprite(17, 18));
  addTile(DARK_KNIGHT, sprite(12, 14));
  addTile(GREEN_DRAGON, sprite(3, 18));
  addTile(RED_DRAGON, sprite(0, 18));
  ...
  addTile(BARRICADE, sprite(13, 10, 2).setNoShadow());
...
void genSymbols() {
  ...
  addSymbol(KRAKEN, symbol("S", DARK_GREEN));
  addSymbol(DEATH, symbol("D", DARK_GRAY));
  addSymbol(KRAKEN2, symbol("S", GREEN));
