...
void Technology::init() {
  ...
  Technology::set(TechId::ALCHEMY_ADV, new Technology("advanced alchemy", base, {TechId::ALCHEMY}));
  ...
  Technology::set(TechId::BEAST_MUT, new Technology("beast mutation", base, {TechId::BEAST}));
  ...
  Technology::set(TechId::SPELLS_MAS, new Technology("master sorcery", base, {TechId::SPELLS_ADV}));
...
Technology::Technology(const string& n, int c, const vector<TechId>& pre) : name(n), cost(c) {
  for (TechId id : pre)
