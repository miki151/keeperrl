...
class Level {
  ...
  class Builder {
    ...
    void putSquare(Vec2, SquareType, Optional<SquareAttrib> = Nothing(), bool onBackground = false);
    void putSquare(Vec2, SquareType, vector<SquareAttrib> attribs, bool onBackground = false);
    void putSquare(Vec2, Square*, SquareType, Optional<SquareAttrib> = Nothing(), bool onBackground = false);
    void putSquare(Vec2, Square*, SquareType, vector<SquareAttrib> attribs, bool onBackground = false);
    //@}
