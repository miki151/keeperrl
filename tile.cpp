...
class TileCoordLookup {
  ...
  void genTiles() {
    ...
    Tile::addTile(ViewId::ARROW_N, sprite("arrow_n"));
    Tile::addTile(ViewId::ARROW_NE, sprite("arrow_ne"));
    Tile::addTile(ViewId::ARROW_E, sprite("arrow_e"));
    Tile::addTile(ViewId::ARROW_SE, sprite("arrow_se"));
    Tile::addTile(ViewId::ARROW_S, sprite("arrow_s"));
    Tile::addTile(ViewId::ARROW_SW, sprite("arrow_sw"));
    Tile::addTile(ViewId::ARROW_W, sprite("arrow_w"));
    Tile::addTile(ViewId::ARROW_NW, sprite("arrow_nw"));
    Tile::addTile(ViewId::WOODEN_WAND, sprite("wand_wooden"));
    Tile::addTile(ViewId::FORCE_BOLT_N, sprite("force_bolt_n"));
    Tile::addTile(ViewId::FORCE_BOLT_NE, sprite("force_bolt_ne"));
    Tile::addTile(ViewId::FORCE_BOLT_E, sprite("force_bolt_e"));
    Tile::addTile(ViewId::FORCE_BOLT_SE, sprite("force_bolt_se"));
    Tile::addTile(ViewId::FORCE_BOLT_S, sprite("force_bolt_s"));
    Tile::addTile(ViewId::FORCE_BOLT_SW, sprite("force_bolt_sw"));
    Tile::addTile(ViewId::FORCE_BOLT_W, sprite("force_bolt_w"));
    Tile::addTile(ViewId::FORCE_BOLT_NW, sprite("force_bolt_nw"));
  ...
  void genSymbols() {
    ...
    Tile::addSymbol(ViewId::ARROW_N, symbol(u8"|", Color::BROWN));
    Tile::addSymbol(ViewId::ARROW_NE, symbol(u8"/", Color::BROWN));
    Tile::addSymbol(ViewId::ARROW_E, symbol(u8"-", Color::BROWN));
    Tile::addSymbol(ViewId::ARROW_SE, symbol(u8"\\", Color::BROWN));
    Tile::addSymbol(ViewId::ARROW_S, symbol(u8"|", Color::BROWN));
    Tile::addSymbol(ViewId::ARROW_SW, symbol(u8"/", Color::BROWN));
    Tile::addSymbol(ViewId::ARROW_W, symbol(u8"-", Color::BROWN));
    Tile::addSymbol(ViewId::ARROW_NW, symbol(u8"\\", Color::BROWN));
    Tile::addSymbol(ViewId::FORCE_BOLT_N, symbol(u8"|", Color::BROWN));
    Tile::addSymbol(ViewId::FORCE_BOLT_NE, symbol(u8"/", Color::BROWN));
    Tile::addSymbol(ViewId::FORCE_BOLT_E, symbol(u8"-", Color::BROWN));
    Tile::addSymbol(ViewId::FORCE_BOLT_SE, symbol(u8"\\", Color::BROWN));
    Tile::addSymbol(ViewId::FORCE_BOLT_S, symbol(u8"|", Color::BROWN));
    Tile::addSymbol(ViewId::FORCE_BOLT_SW, symbol(u8"/", Color::BROWN));
    Tile::addSymbol(ViewId::FORCE_BOLT_W, symbol(u8"-", Color::BROWN));
    Tile::addSymbol(ViewId::FORCE_BOLT_NW, symbol(u8"\\", Color::BROWN));
