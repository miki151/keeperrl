...
void Spell::init() {
  ...
  set(SpellId::DAM_BONUS, new Spell("damage", Effect::Lasting{LastingEffect::DAM_BONUS}, 50,
        SoundId::SPELL_STR_BONUS, FXInfo(FXName::CIRCULAR_SPELL, Color::LIGHT_RED)));
  set(SpellId::DEF_BONUS, new Spell("defense", Effect::Lasting{LastingEffect::DEF_BONUS}, 50,
  ...
  set(SpellId::FIRE_SPHERE_PET, new Spell("fire sphere", Effect::Summon{CreatureId::FIRE_SPHERE}, 80,
  ...
  set(SpellId::BLAST,
      new Spell("blast", DirEffectType(4, DirEffectId::BLAST), 30, SoundId::SPELL_BLAST, {FXName::AIR_BLAST}));
  set(SpellId::MAGIC_MISSILE, new Spell("magic missile", DirEffectType(4, DirEffectId::CREATURE_EFFECT,
      Effect::Damage{AttrType::SPELL_DAMAGE, AttackType::SPELL}), 20, SoundId::SPELL_BLAST, {FXName::MAGIC_MISSILE}, {FXName::MAGIC_MISSILE_SPLASH}));
  ...
  set(SpellId::FIREBALL_DRAGON, new Spell("fireball_dragon", DirEffectType(4, DirEffectId::FIREBALL), 3, SoundId::SPELL_BLAST,
              {FXName::FLAMETHROWER}, {FXName::FIREBALL_SPLASH}));
  ...
  set(SpellId::SUMMON_ELEMENT, new Spell("summon element", Effect::SummonElement{}, 50, SoundId::SPELL_SUMMON_SPIRIT));
}
