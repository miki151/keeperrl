...
void Spell::init() {
  ...
  set(SpellId::DAM_BONUS, new Spell("damage", Effect::Lasting{LastingEffect::DAM_BONUS}, 50, SoundId::SPELL_STR_BONUS));
  ...
  set(SpellId::BLAST,
      new Spell("blast", DirEffectType(4, DirEffectId::BLAST), 30, SoundId::SPELL_BLAST));
