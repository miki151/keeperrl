...
SRCS = time_queue.cpp level.cpp model.cpp square.cpp util.cpp monster.cpp square_factory.cpp view.cpp creature.cpp item_factory.cpp item.cpp inventory.cpp debug.cpp player.cpp window_view.cpp field_of_view.cpp view_object.cpp creature_factory.cpp shortest_path.cpp effect.cpp equipment.cpp level_maker.cpp monster_ai.cpp attack.cpp tribe.cpp name_generator.cpp event.cpp location.cpp skill.cpp fire.cpp ranged_weapon.cpp map_layout.cpp trigger.cpp map_memory.cpp view_index.cpp collective.cpp player_control.cpp task.cpp controller.cpp village_control.cpp poison_gas.cpp minion_equipment.cpp statistics.cpp options.cpp renderer.cpp tile.cpp map_gui.cpp gui_elem.cpp item_attributes.cpp creature_attributes.cpp serialization.cpp unique_entity.cpp entity_set.cpp entity_map.cpp gender.cpp main.cpp gzstream.cpp singleton.cpp technology.cpp encyclopedia.cpp input_queue.cpp minimap_gui.cpp music.cpp test.cpp sectors.cpp vision.cpp animation.cpp clock.cpp square_type.cpp creature_action.cpp collective_control.cpp renderable.cpp bucket_map.cpp task_map.cpp movement_type.cpp collective_builder.cpp player_message.cpp minion_task_map.cpp gui_builder.cpp known_tiles.cpp collective_teams.cpp progress_meter.cpp creature_name.cpp collective_config.cpp spell.cpp spell_map.cpp spectator.cpp visibility_map.cpp model_builder.cpp file_sharing.cpp stack_printer.cpp highscores.cpp main_loop.cpp construction_map.cpp level_builder.cpp move_info.cpp movement_set.cpp position.cpp stair_key.cpp position_map.cpp collective_attack.cpp territory.cpp drag_and_drop.cpp sound.cpp sound_library.cpp campaign.cpp game.cpp sunlight_info.cpp creature_listener.cpp event_generator.cpp collective_name.cpp
