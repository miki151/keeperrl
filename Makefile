...
CFLAGS = -Wall -std=c++1y -Wno-sign-compare -Wno-unused-variable -Wno-unused-function -Wno-shift-count-overflow -Wno-tautological-constant-out-of-range-compare -Wno-mismatched-tags -ftemplate-depth=512
