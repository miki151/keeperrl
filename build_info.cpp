...
const vector<BuildInfo>& BuildInfo::get(AvatarVariant avatarVariant) {
  static EnumMap<AvatarVariant, vector<BuildInfo>> buildInfo([](AvatarVariant avatarVariant) {
    ...
    vector<BuildInfo> buildInfo {
      ...
      BuildInfo({{FurnitureType::DUNGEON_WALL, FurnitureType::DUNGEON_WALL2}, {ResourceId::STONE, 3}}, "Reinforce wall", {},
      ...
      BuildInfo({FurnitureType::WOOD_WALL, {ResourceId::WOOD, 5}}, "Wooden building", {}, ".", 0, "Structure"),
      BuildInfo({FurnitureType::CASTLE_WALL, {ResourceId::STONE, 5}}, "Stone building", {}, ".", 0, "Structure"),
