...
ItemFactory ItemFactory::villageShop() {
  return ItemFactory({
      ...
      {ItemType::Torch{}, 10 },
      {ItemType::Scroll{Effect::Summon{"FIRE_ELEMENTAL", Range(1, 2)}}, 5 },
...
ItemFactory ItemFactory::scrolls() {
  return ItemFactory({
      ...
      {ItemType::Scroll{Effect::Summon{"FIRE_ELEMENTAL", Range(1, 2)}}, 1 },
      {ItemType::Scroll{Effect::CircularBlast{}}, 1 },
...
ItemFactory ItemFactory::dungeon() {
  return ItemFactory({
      ...
      {ItemType::Scroll{Effect::Summon{"FIRE_ELEMENTAL", Range(1, 2)}}, 30 },
