...
unique_ptr<Workshops> CollectiveConfig::getWorkshops() const {
  return unique_ptr<Workshops>(new Workshops({
      ...
      {WorkshopType::JEWELER, {
          ...
          Workshops::Item::fromType(ItemType::Ring{LastingEffect::FAST_CRAFTING}, 10,
              {CollectiveResourceId::GOLD, 40}),
          Workshops::Item::fromType(ItemType::Ring{LastingEffect::FAST_TRAINING}, 10,
              {CollectiveResourceId::GOLD, 40}),
