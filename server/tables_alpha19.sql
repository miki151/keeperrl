...
DROP TABLE IF EXISTS `event_single_started`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `event_single_started` (
  `id` int(7) unsigned NOT NULL AUTO_INCREMENT,
  `game_id` varchar(40) NOT NULL,
  `install_id` varchar(40) NOT NULL,
  `timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
--
-- Table structure for table `highscores2`
--

DROP TABLE IF EXISTS `highscores2`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `retired_games`
--

DROP TABLE IF EXISTS `retired_games`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `retired_games` (
  `id` int(6) unsigned NOT NULL AUTO_INCREMENT,
